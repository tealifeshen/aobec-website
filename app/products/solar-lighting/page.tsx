...
const lightingProducts = [
  {
    number: "01",
    title: "Rural Solar Street Light",
    eyebrow: "Rural & Community Lighting",
    image: "/images/products/solar-rural-integrated.jpg",
    description:
      "Independent solar street lighting designed for locations where grid access is limited, unreliable or unavailable.",
    applications: ["Remote Villages", "Rural Roads", "Communities"],
    parameters: [
      { label: "LED Power", value: "30W–100W" },
      { label: "Solar Panel", value: "80W–200W" },
      { label: "Battery", value: "LiFePO4" },
      { label: "Application", value: "Off-grid Lighting" },
    ],
  },
  {
    number: "02",
    title: "Commercial Solar Street Light",
    eyebrow: "Commercial & Public Infrastructure",
    image: "/images/products/solar-commercial-split.jpg",
    description:
      "Higher-output solar lighting configurations for urban roads, industrial developments and public projects.",
    applications: ["Urban Roads", "Industrial Parks", "Public Infrastructure"],
    parameters: [
      { label: "LED Power", value: "100W–300W" },
      { label: "Solar Panel", value: "200W–600W" },
      { label: "Battery", value: "LiFePO4" },
      { label: "Application", value: "Road / Public Projects" },
    ],
  },
  {
    number: "03",
    title: "High Mast & Flood Lighting",
    eyebrow: "Industrial & Large-area Lighting",
    image: "/images/products/solar-high-mast.jpg",
    description:
      "High-output lighting systems engineered for broad coverage, demanding environments and large infrastructure sites.",
    applications: ["Highways", "Ports", "Factories", "Large Areas"],
    parameters: [
      { label: "LED Power", value: "300W–1000W+" },
      { label: "Lighting Type", value: "High Mast / Flood Light" },
      { label: "Application", value: "Industrial / Large Area" },
    ],
  },
];
...
const advantages = [
  {
    ...
    description:
      "Match lighting output, solar generation, battery capacity and pole configuration to each project environment.",
  },
  {
    number: "02",
    title: "Quality Control & Testing",
    description:
      "Coordinate specifications, production checks, lighting tests and export documentation before delivery.",
  },
  {
    number: "03",
    title: "Global Project Delivery",
    description:
      "Support packaging, logistics, installation documentation and international project coordination.",
  },
];
    ...
    <main className="min-h-screen bg-[#071523] text-white">
      <section className="relative flex min-h-[760px] items-center overflow-hidden pt-20">
        <div
          ...
          style={{
            backgroundImage:
              'url("/images/products/solar-lighting-hero.jpg")',
          }}
        />
        ...
        <div className="site-container relative z-10 py-24">
          <div className="max-w-5xl">
            ...
            <p className="mt-8 max-w-2xl text-base leading-8 text-[#d8e2e9] sm:text-lg">
              Reliable solar lighting solutions for roads, communities,
              commercial areas and off-grid applications worldwide.
            </p>
      ...
      >
        <div className="site-container">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-end">
            <div>
              <p className="section-kicker">Solar Lighting Categories</p>
            ...
            <p className="section-copy max-w-xl lg:justify-self-end">
              Select a lighting platform according to road class, required
              illumination, local solar conditions and installation
              environment.
            </p>
          </div>
                ...
                <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
                  ...
                  <div className="p-8 md:p-10 lg:p-12">
                    ...
                    <p className="mt-6 text-xs leading-6 text-[#7a8994]">
                      ...
                      specifications depend on lighting design, project
                      location and technical assessment.
                    </p>
                  </div>
                </div>
              </article>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr]">
            <div>
              ...
              <h2 className="mt-5 text-4xl font-black leading-[1.05] tracking-[-0.04em] md:text-6xl">
                More Than Solar
                <span className="block text-white/48">Lighting Supply.</span>
              </h2>
              <p className="mt-6 max-w-lg text-sm leading-7 text-white/55">
                AOBEC connects lighting selection, configuration, quality
        ...
        <div className="site-container">
          <div className="relative overflow-hidden rounded-[38px] border border-white/10 bg-[#0a1d2c] px-7 py-14 md:px-14 md:py-16">
            ...
            <div className="relative z-10 flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.22em] text-[#f28b22]">
                  Start a Solar Lighting Project
                </p>
                <h2 className="mt-5 max-w-4xl text-4xl font-black leading-[1.02] tracking-[-0.045em] md:text-6xl">
                  Need the Right Solar Lighting Solution?
                </h2>
                <p className="mt-6 max-w-2xl text-[15px] leading-7 text-white/58">
                  Share your project location, road or site conditions,
                  lighting requirements and delivery target with our team.
                </p>
              </div>
