...
const solarProducts = [
  {
    ...
    eyebrow: "Homes & Small Properties",
    image: "/images/products/solar-residential.jpg",
    description:
      "Flexible rooftop solar systems designed to reduce electricity costs, increase energy independence and support future storage integration.",
    applications: ["Residential Rooftops", "Villas", "Small Businesses"],
    parameters: [
      { label: "Typical Capacity", value: "3–30 kWp" },
      { label: "System Type", value: "On-grid / Hybrid" },
      { label: "Installation", value: "Rooftop" },
      { label: "Optional Integration", value: "Battery Storage" },
    ],
  },
  {
    number: "02",
    ...
    description:
      "Scalable solar generation for factories, warehouses, offices and commercial facilities with significant daytime energy demand.",
    applications: ["Factories", "Warehouses", "Commercial Buildings"],
    parameters: [
      { label: "Typical Capacity", value: "100 kWp–10 MWp" },
      { label: "System Type", value: "On-grid / Hybrid" },
      { label: "Installation", value: "Roof / Carport / Ground" },
      { label: "Optional Integration", value: "C&I Energy Storage" },
    ],
  },
  {
    number: "03",
    title: "Utility Scale Solar PV",
    eyebrow: "Large-scale Power Generation",
    image: "/images/products/solar-utility-scale.jpg",
    description:
      "Large-scale photovoltaic solutions for independent power producers, utilities and renewable energy developments.",
    applications: ["Solar Farms", "Utility Projects", "Hybrid Power Plants"],
    parameters: [
      { label: "Typical Capacity", value: "10 MWp+" },
      { label: "System Type", value: "Grid-connected" },
      { label: "Installation", value: "Ground-mounted" },
      { label: "Optional Integration", value: "Utility BESS" },
    ],
  },
];
...
const advantages = [
  {
    number: "01",
    title: "System Design & Product Integration",
    description:
      "Coordinate modules, inverters, mounting structures and optional storage around the needs of each project.",
  },
  {
    number: "02",
    title: "Quality Control & Documentation",
    description:
      "Support technical review, supplier coordination, inspection and international project documentation.",
  },
  {
    number: "03",
    title: "Global Project Delivery",
    description:
      "Manage export coordination, logistics and technical handover for solar projects in global markets.",
  },
];
    ...
    <main className="min-h-screen bg-[#071523] text-white">
      <section className="relative flex min-h-[760px] items-center overflow-hidden pt-20">
        <div
          ...
          style={{
            backgroundImage: 'url("/images/products/solar-power-hero.jpg")',
          }}
        />
        ...
        <div className="site-container relative z-10 py-24">
          <div className="max-w-5xl">
            ...
            <p className="mt-8 max-w-2xl text-base leading-8 text-[#d8e2e9] sm:text-lg">
              Reliable solar power solutions for residential, commercial,
              industrial and utility-scale energy projects worldwide.
            </p>
      ...
      >
        <div className="site-container">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.7fr] lg:items-end">
            <div>
              <p className="section-kicker">Solar Product Categories</p>
            ...
            <p className="section-copy max-w-xl lg:justify-self-end">
              Select a solar platform according to energy demand, installation
              environment, grid conditions and long-term project objectives.
            </p>
          </div>
                ...
                <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
                  ...
                  <div className="p-8 md:p-10 lg:p-12">
                    ...
                    <p className="mt-6 text-xs leading-6 text-[#7a8994]">
                      ...
                      specifications depend on site conditions, system design
          ...
          <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr]">
            <div>
              ...
              <h2 className="mt-5 text-4xl font-black leading-[1.05] tracking-[-0.04em] md:text-6xl">
                More Than
                <span className="block text-white/48">Solar Product Supply.</span>
              </h2>
